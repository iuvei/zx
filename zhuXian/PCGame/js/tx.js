...
$(document).ready(function() {
    ...
    //同人大赏动态生成
    var datas_ap = [
        { "content": "牙签+502,原创手工,翠微翠微翠微", "name": "作者：执念..°" },
        { "content": "同人壁纸:新学期,手机快翠微翠微翠微", "name": "作者：元宝小哥哥" },
        { "content": "跟秋天更配的当然还是枫叶翠微翠微翠微", "name": "作者：乀杭灬丹青丶" },
        { "content": "跟着女王打天下:逆黑白,墨翠微翠微翠微", "name": "作者：言一_rem" },
        { "content": "同人COS:五年天下路,一身白翠微翠微翠微", "name": "作者：爱喝酒的沉圆怡" },
        { "content": "同人壁纸:行走大荒，勿失本翠微翠微翠微", "name": "作者：阿顾" },
        { "content": "同跟着女王打天下:女王的背翠微翠微翠微", "name": "作者：子隐-折戟沉沙秋水溟" },
        { "content": "同人绘画:冥心归太虚,天翠微翠微翠微", "name": "作者：吸毒养身体" }
    ];
    ...
    $(function() {
        ...
        for (var i = 0; i < $li.length; i++) {
            ...
            $li.eq(i).css("backgroundImage", "url('images/t" + (i + 1) + ".jpg')").css("left", i * 171).prop("index",i);
        }
        ...
        $li.mouseenter(function() {
            ...
            $li.each(function(index, val) {
                if (index <= idx) {
                    $(this).stop().animate({ "left": index * 120 }, 300);
                } else {
